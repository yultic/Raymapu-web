...
import { MapPin, Waves, Car, Phone } from "lucide-react"
...
const info = [
  ...
  {
    icon: Waves,
    title: "Cerca de todo lo importante",
    description:
      "A solo 4 km de las Termas del Sol y a 8 km del pueblo de Río Puelo. El punto de partida perfecto para explorar la Patagonia Norte.",
  },
  {
    icon: Car,
    title: "Cómo llegar",
    description: "Acceso pavimentado. Estacionamiento gratuito. Señalización desde la ruta principal.",
  },
  {
    icon: Phone,
      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            <h2 className="text-display-md font-bold text-foreground mb-6">Planifica tu estadía</h2>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              La cabaña se encuentra dentro de nuestro campo en Río Puelo, junto al apiario y los senderos
              del bosque. Aquí tienes todo lo que necesitas saber antes de venir.
            </p>
          ...
          <div className="lg:col-span-5">
            ...
            >
              <iframe
                ...
                title="Ubicación Cabaña Raymapu"
